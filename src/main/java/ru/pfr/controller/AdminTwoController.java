...
import ru.pfr.service.AdminparamService;
...
/*    @Autowired
    ...
    public String table(@RequestParam String d1,
        ...
        return "fragmentupfr/adminfragment :: tables";
    }
    ...
    public String admintwoclear(@RequestParam Long id,
        ...
        return "fragmentupfr/adminfragment :: blocks";
    }


    @GetMapping("/admintwo/zablock")
